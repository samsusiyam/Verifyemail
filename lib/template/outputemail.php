...
class outputemail
{
    public function index($vars)
    {
        ...
        $badge1 = $Emailauthentication == "on" ? "hn-badge-on" : "hn-badge-off";
        $badge1txt = $Emailauthentication == "on" ? "ON" : "OFF";
        $badge2 = $Userauthentication == "on" ? "hn-badge-on" : "hn-badge-off";
        $badge2txt = $Userauthentication == "on" ? "ON" : "OFF";
        $badge3 = $Deletedatabase == "on" ? "hn-badge-on" : "hn-badge-off";
        ...
        <div class="hn-layout">
            <aside class="hn-sidebar">
                <div class="hn-brand">
                    ...
                    <div>
                        <span class="hn-brand-name">HosT NIbo</span>
                        <span class="hn-brand-sub">Email Verify</span>
                    </div>
                </div>
                <nav class="hn-nav">
                    <a href="{$modulelink}&page=index" class="hn-nav-item active">
                        ...
                        <span>{$LANG['menu']['setting-email-active']}</span>
                    </a>
                    <a href="{$modulelink}&page=about" class="hn-nav-item">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                        <span>{$LANG['menu']['aboutanicoweb']}</span>
                    </a>
                </nav>
                <div class="hn-sidebar-footer">
            ...
            <main class="hn-main">
                <div class="hn-topbar">
                    <div>
                        <h1 class="hn-page-title">Email Verification</h1>
                        <p class="hn-page-sub">Manage your verification settings</p>
                    </div>
                    <a class="hn-topbar-link" href="configgeneral.php?nocache=yc4opdjzyLEJ43Zn#tab=10">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
                        {$LANG['Warning']['go-to-configgeneral']}
                    </a>
                </div>

                <div class="hn-warning">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    <span>{$LANG['Warning']['dec-configgeneral']}</span>
                </div>

                <div class="hn-stats">
                    <div class="hn-stat-card">
                        <div class="hn-stat-icon hn-stat-purple">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                        </div>
                        <div>
                            <span class="hn-stat-label">{$LANG['setting']['Emailconfirmation']}</span>
                            <span class="hn-stat-badge {$badge1}">{$badge1txt}</span>
                        </div>
                    </div>
                    <div class="hn-stat-card">
                        <div class="hn-stat-icon hn-stat-indigo">
                        ...
                        <div>
                            <span class="hn-stat-label">{$LANG['setting']['Userauthentication']}</span>
                            <span class="hn-stat-badge {$badge2}">{$badge2txt}</span>
                        </div>
                    </div>
                    <div class="hn-stat-card">
                        <div class="hn-stat-icon hn-stat-rose">
                        ...
                        <div>
                            <span class="hn-stat-label">{$LANG['setting']["Deletedatabase"]}</span>
                            <span class="hn-stat-badge {$badge3}">{$badge3txt}</span>
                        </div>
                    </div>
                </div>

                <form class="hn-form" action="#" method="post">
                    ...
                    <label class="hn-card">
                        <div class="hn-card-body">
                            <div class="hn-card-icon hn-icon-envelope">@</div>
                            <div>
                                <div class="hn-card-label">{$LANG['setting']['Emailconfirmation']}</div>
                                <div class="hn-card-desc">{$LANG['setting']['dec-confirmemail']}</div>
                            </div>
                        </div>
                        <input type="checkbox" {$checked} name="Emailauthentication" id="Emailauthentication">
                        <span class="hn-toggle"></span>
                    </label>

                    <label class="hn-card">
                        <div class="hn-card-body">
                            <div class="hn-card-icon hn-icon-shield">!</div>
                            <div>
                                <div class="hn-card-label">{$LANG['setting']['Userauthentication']}</div>
                                <div class="hn-card-desc">{$LANG['setting']['dec-Userauthentication']}</div>
                            </div>
                        </div>
                    ...
                    <label class="hn-card">
                        <div class="hn-card-body">
                            <div class="hn-card-icon hn-icon-trash">&#10005;</div>
                            <div>
                                <div class="hn-card-label">{$LANG['setting']["Deletedatabase"]}</div>
                                <div class="hn-card-desc">{$LANG['setting']['dec-Deletedatabase']}</div>
                            </div>
                        </div>
                    ...
                    <div class="hn-form-actions">
                        <button type="submit" class="hn-btn" name="submit">
    ...
    public function about($vars)
    {
        ...
        <div class="hn-layout">
            <aside class="hn-sidebar">
                ...
                <nav class="hn-nav">
                    <a href="{$modulelink}&page=index" class="hn-nav-item">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
                        <span>{$LANG['menu']['setting-email-active']}</span>
                    </a>
                    <a href="{$modulelink}&page=about" class="hn-nav-item active">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                        <span>{$LANG['menu']['aboutanicoweb']}</span>
                    </a>
                </nav>
            ...
            <main class="hn-main">
                <div class="hn-topbar">
                    <div>
                        <h1 class="hn-page-title">{$LANG['menu']['aboutanicoweb']}</h1>
                        <p class="hn-page-sub">About this module</p>
                    </div>
                </div>
                <div class="hn-about-card">
                    <div class="hn-about-icon">
